  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_637534251 < n_285212852)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212867 = i_637534251;
            F.line = 49;
            ...
            F.line = 122;
            i_637534251 = addInt(i_637534251, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556520(f_33556521) {
  var result_33556522 = [[]];
    ...
    Label5: {
      var j_33556563 = 0;
      var colontmp__637534243 = 0;
      colontmp__637534243 = (i_33556531 - 1);
      var res_637534245 = colontmp__637534243;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_637534245)) break Label7;
            j_33556563 = res_637534245;
...
F.line = 57;
failedAssertImpl_251658296(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(12, 10) `data.hasKey(\"key0\")` "));
}

if (!((data_637534210.get("key0") == "value0"))) {
F.line = 57;
failedAssertImpl_251658296(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(13, 10) `data[\"key0\"] == \"value0\".cstring` "));
}
...
F.line = 57;
failedAssertImpl_251658296(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(15, 10) `data.len == 0` "));
}
