  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_905969702 < n_285212852)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212867 = i_905969702;
            F.line = 49;
...
F.line = 224;
failedAssertImpl_251658296(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsffi_examples_2.nim(10, 10) `obj.a.to(int) == 20` "));
}
